...
globals [
  U       ; Interval where the function will be approximated
...
to Setup
  ...
  set U [-1 1]
  set Ipoints (Interval-Points U 100)
...
to AI:Compute-fitness
  ...
  if fitness < -50000 [set fitness -50000]
end
...
to plotf [f]
  ...
  clear-plot
  set-plot-x-range (first U) (last U)
  foreach Ipoints [
    x ->
...
Metodo_de_Seleccion
Metodo_de_Seleccion
"Torneo" "Rango" "Ruleta" "Estado Estable" "Elitismo"
4
